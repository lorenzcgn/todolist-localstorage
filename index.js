...
// setto le liste come true o false
...
const confirmDialogue = function (buttonClicked) {
	...
	noButton.textContent = 'Annulla';
	noButton.setAttribute('class', 'button alert__button alert__button--no btn blacck');
	yesButton.setAttribute('class', 'button alert__button alert__button--yes btn blacck');
	yesButton.textContent = 'Conferma';
	alertContainer.innerHTML = '<p>Sicuro di voler eliminare la nota?</p>';
...
const confirmDialogue2 = function () {
	let noButton = document.createElement('button');
	let yesButton = document.createElement('button');
	let divContainer = document.createElement('div');
	let alertContainer = document.createElement('div');
	alertContainer.className = 'alert2';
	noButton.textContent = 'Annulla';
	noButton.setAttribute('class', 'button alert__button alert__button--no btn blacck');
	yesButton.setAttribute('class', 'button alert__button alert__button--yes btn blacck');
	yesButton.textContent = 'Conferma';
	alertContainer.innerHTML = '<p>Sicuro di voler eliminare tutte le note?</p>';
	alertContainer.appendChild(noButton);
	alertContainer.appendChild(yesButton);
	divContainer.className = 'overlay';
	divContainer.appendChild(alertContainer);
...
// Aggiungi attività anche con l'invio
